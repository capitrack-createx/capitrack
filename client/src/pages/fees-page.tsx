            ...
            <div className="rounded-md border overflow-x-auto">
              <div className="min-w-[600px] lg:min-w-0">
                ...
                <div className="divide-y">
                  {fees.map(fee => (
                    <div key={fee.id} className="grid grid-cols-5 gap-4 p-4 items-center hover:bg-muted/50">
                      <div className="font-medium">{fee.name}</div>
                      <div className="text-blue-600 font-medium">${fee.amount}</div>
                      ...
                      {assignments[selectedFee].map(assignment => {
                        ...
                        return (
                          ...
                          >
                            ...
                            {!assignment.isPaid && (
                              <button
                                onClick={() => handlePayFee(assignment, fees.find(f => f.id === selectedFee)!)}
